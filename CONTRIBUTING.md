...
| `npm run typecheck` | Validates TypeScript types across `packages/zero-auth/src/` and `packages/zero-auth/tests/` without emitting files. |
...
Run the documentation build when changing package documentation, README.md, or docs/:
...
by hand. Update public TypeScript comments in packages/zero-auth/src/ and
rebuild the docs instead.
...
- Installation and quick-start changes belong in packages/zero-auth/README.md and docs/quick-start.md.
...
- Version or migration changes belong in packages/zero-auth/CHANGELOG.md and docs/versioning.md.
